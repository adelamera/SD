...
public class FindByIdShowWindow {

	public void findSFrame() {
		JFrame principalFrame = new JFrame("Find show");
		...
		JTextField idShowText = new JTextField("Enter show's id to find");
		...
		showText.setBounds(250, 270, 200, 50);
		panel.add(showText);
		...
		find.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				ShowModel show = showService.findById(idShow);
