...
public class MakeReservationWindow {

	public void makeFrame() {
		JFrame principalFrame = new JFrame("Make Reservation");
		...
		JLabel success = new JLabel("The booking was successfully completed");
		success.setBounds(10, 100, 300, 50);
		panel2.add(success);

		JLabel error = new JLabel("The ticket is not free");
		error.setBounds(10, 100, 300, 50);
		panel3.add(error);

		JTextField idTicketText = new JTextField("Enter the ticket's id");
		idTicketText.setBounds(250, 70, 200, 50);
		panel.add(idTicketText);

		JButton book = new JButton("BOOK");
		book.setBounds(250, 170, 200, 50);
		panel.add(book);
		...
		book.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				TicketModel ticketToBook = ticketService.getTicketById(idTicket);
				boolean booked = ticketService.makeReservation(ticketToBook);
				if (booked) {
